...
public class CrashedDeskRebalanceListener implements ConsumerRebalanceListener {
	...
	public void onPartitionsAssigned(Collection<TopicPartition> partitions) {
		// TODO the consumer should get ready to process messages coming from these
		// partitions
	...
	public void onPartitionsRevoked(Collection<TopicPartition> partitions) {
		...
		// partitions, and commit anything that the new consumer handling this partition
		// would require Map<Integer, Map<Integer, Instant>> Partition ID -> desk ID ->
		// last status
